...
class Engine {
    private:
        ...
        /// @brief Triangular obstacles to be rendered.
        /// @details Initialized in initShapes()
        vector<unique_ptr<Triangle>> triObstacles;

        /// @brief The player object.
        /// @details Initialized in initShapes()
        unique_ptr<Shape> player;

        /// @brief The level objects
        /// @details used in processInput()
        unique_ptr<Rect> playButton;
